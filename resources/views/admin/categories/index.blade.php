...
<div class="container">
  ...
  <hr>
  <a href="{{route('admin.category.create')}}" class="btn btn-outline-dark pull-right"> צור קטגוריה <i class="fa
    fa-plus-square-o"></i>
  </a>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right">
          <form onsubmit="if(confirm('למחוק?')){ return true }else{ return false }" action="{{route('admin.category.destroy', $category)}}" method="post">
